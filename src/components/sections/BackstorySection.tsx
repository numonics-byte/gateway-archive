import ClassifiedSphereScene from '@/components/backstory/ClassifiedSphereScene'
    ...
    <section className="py-14 sm:py-20 border-t border-border bg-background relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="hidden lg:block h-[480px] relative">
            {/* Radial glow behind sphere */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-72 h-72 rounded-full bg-destructive/8 blur-3xl" />
            </div>
            <ClassifiedSphereScene />
          </div>
